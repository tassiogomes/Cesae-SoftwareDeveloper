...
class Main {
  public static void main(String[] args) {
        ...
        for (int i = 1; i < controle; i++) {
            ...
            arr[i] = input.nextInt();
                if(arr[i]>maior && arr[i]% 2==0){ //testar o maior e par -- se ele nao entrar aqui, o maior é impar.
                    maior=arr[i];
                }
            if(maior % 2 == 0){ // se o maior entrou no ciclo anterior ele virou par e entra aqui
                System.out.println("O maior par é :" + maior);
            }else{              // se ele nao virou par, é porque só entraram ímpares                                            
