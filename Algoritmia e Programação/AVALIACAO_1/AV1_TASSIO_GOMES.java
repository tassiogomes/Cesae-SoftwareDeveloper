...
class Main {
  public static void main(String[] args) {
    ...
    System.out.println("A preço da diária é: " + preco);
    System.out.println("O valor da limpeza por dia é: " + limpeza);
    System.out.println("A % do desconto pro estado é: " + desconto);
    System.out.println("O quarto intruduzdo foi o " + num_quarto + " , tipo de quarto é " + tipo_quarto+ " e o número de dias ocupado por ano é: " + num_dias);
    System.out.println("Total do custo da limpeza:  " + custo_limpeza);
    System.out.println("Receita Bruta: " + receita_bruta);
    System.out.println("Valor de descontos fiscais a entregar ao estado: " + desconto_estado);
    System.out.println("O valor líquido a receber pelas reservas totais: " + lucro);
    System.out.println("Valor líquido a receber pelo quarto: " + lucro_quarto );
