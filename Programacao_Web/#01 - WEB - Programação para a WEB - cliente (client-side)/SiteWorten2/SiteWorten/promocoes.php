        ...
        <div id="carouselExampleCaptions" class="carousel slide w-75 mx-auto" data-bs-theme="dark">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="img/produtos/bancada_trabalho.webp" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                  <h5>Bancada de Trabalho</h5>
                  <p>35€</p>
                </div>
              </div>
              <div class="carousel-item">
                <img src="img/produtos/discos_rebarbadora.webp" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                  <h5>Discos de Rebarbadora</h5>
                  <p>5€</p>
                </div>
              </div>
              <div class="carousel-item">
                <img src="img/produtos/robo_aspirador.webp" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
              ...
              <div class="carousel-item">
                <img src="img/produtos/wd_40.webp" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                  <h5>WD-50</h5>
                  <p>12€</p>
                </div>
