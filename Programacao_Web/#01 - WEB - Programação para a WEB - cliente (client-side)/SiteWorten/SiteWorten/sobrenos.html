...
<body>
    ...
    <main class="container shadow mb-3 rounded">
        <img class="w-100" src="img/frente-loja.webp" alt=""> <!-- w-100 faz a imagem ficar responsiva-->
        <h1>Sobre a Worten</h1>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repudiandae facere doloribus dolorum aliquam eum minus dolores enim laudantium ex quo deserunt, perferendis distinctio expedita maxime, dignissimos laborum odit explicabo dolore?</p>
